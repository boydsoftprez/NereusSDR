...
### Current Phase: v0.2.3 shipped 2026-04-24 — RX epic + Alex antennas complete. **3M-1 SSB TX shipped via PR #152 (2026-04-29).** Next major epic is **3M-3 TX Processing Chain**; 3M-2 CW TX deferred until after 3M-3 + the HL2 att/filter safety audit closes (HL2 TX bench was deferred during 3M-1c after JJ flagged ATT/filter code paths that could damage the radio if engaged — see PR #152 rows 58-60).
