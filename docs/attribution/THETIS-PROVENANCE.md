...
| src/core/FFTEngine.cpp | Project Files/Source/Console/display.cs; Project Files/Source/Console/PanDisplay.cs | 2842; 4699-4700 | port | multi-source | display.cs constants (-200 dBm floor); PanDisplay.cs sliding-window stride formula `incr = sample_rate / frame_rate` (no Samphire on PanDisplay.cs) |
| src/core/FFTEngine.h | Project Files/Source/Console/display.cs; Project Files/Source/Console/PanDisplay.cs | 215; 4699-4700 | port | multi-source | display.cs BUFFER_SIZE = 16384 constant + enum mapping; PanDisplay.cs ring-buffer / stride state shape |
